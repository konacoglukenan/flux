                    ...
                    Expanded(
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            buildInputField(
                                S.of(context).username, model.username, false),
                            buildInputField(
                                S.of(context).email, model.userEmail, false),
                            buildInputField(S.of(context).displayName,
                                model.userDisplayName),
                            buildInputField(
                                S.of(context).firstName, model.userFirstName),
                            buildInputField(
                            ...
                            if (!ServerConfig().isListingType) ...[
                              ...
                              buildInputField(S.of(context).stateProvince,
                                  model.shippingState),
                              buildInputField(
                                  S.of(context).country, model.shippingCountry),
                              buildInputField(S.of(context).zipCode,
                                  model.shippingPostcode),
                              buildInputField(S.of(context).streetNameApartment,
        ...
        children: <Widget>[
          Container(
            ...
            child: model.avatar == null ||
                    (model.avatar is String && model.avatar.isEmpty)
                ? const SizedBox()
                : ClipRRect(
                    borderRadius: const BorderRadius.vertical(
                      bottom: Radius.elliptical(100, 10),
