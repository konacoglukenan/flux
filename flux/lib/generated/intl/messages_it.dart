...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m26(size) => "Dimensione massima del file: ${size} MB";

  static String m27(currency, amount) =>
      "L\'importo minimo per l\'utilizzo di questo pagamento è ${currency} ${amount}";

  static String m28(minute) => "${minute} minuti fa";

  static String m29(month) => "${month} mesi fa";

  static String m30(store) => "Altro da ${store}";

  static String m31(number) => "deve essere acquistato in gruppi di ${number}";

  static String m32(itemCount) => "${itemCount} prodotti";

  static String m33(price) => "Opzioni totali: ${price}";

  static String m34(amount) => "Paga ${amount}";

  static String m35(name) =>
      "${name} sono stati aggiunti al carrello con successo";

  static String m36(total) => "Qtà: ${total}";

  static String m37(name) => "Ho ricevuto denaro da ${name}";

  static String m38(percent) => "${percent}% di sconto";

  static String m39(keyword) => "Risultati della ricerca per: \'${keyword}\'";

  static String m40(keyword, count) => "${keyword} (${count} elemento)";

  static String m41(keyword, count) => "${keyword} (${count} elementi)";

  static String m42(second) => "${second} secondi fa";

  static String m43(totalCartQuantity) =>
      "Carrello, ${totalCartQuantity} prodotti";

  static String m44(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m45(fieldName) => "Il campo ${fieldName} è obbligatorio";

  static String m46(total) => "${total} Prodotti";

  static String m47(name) => "Trasferisci denaro a ${name}";
  ...
  static String m49(date) => "Valido fino alle ${date}";

  static String m50(balance) => "Saldo del portafoglio: ${balance}";

  static String m51(message) => "Attenzione: ${message}";
  ...
  static String m53(length) => "Abbiamo trovato \$length prodotti";

  static String m54(week) => "Settimana ${week}";

  static String m55(name) => "Benvenuto ${name}";

  static String m56(year) => "${year} anni fa";

  static String m57(total) => "Hai assegnato all\'ordine #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "multipleSellersDetected": MessageLookupByLibrary.simpleMessage(
            "Sono stati rilevati più venditori"),
        "multipleSellersDetectedAndDisableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Stai provando ad aggiungere un prodotto di un nuovo venditore al tuo carrello. Nota che puoi acquistare da un solo venditore alla volta."),
        "multipleSellersDetectedAndEnableMultiVendorCheckoutContent":
            MessageLookupByLibrary.simpleMessage(
                "Stai provando ad aggiungere un prodotto di un nuovo venditore al tuo carrello. Vuoi continuare?"),
